...
def mosaic_tranx(event):
	...
	mosaic_name = input_text4.GetValue()
	mosaic_payload = input_text6.GetValue()
	
	if not (username and private_key and receiver and mosaic_name and mosaic_payload):
		...
		try:
			...
			if msg_len > 1025:
				...
				total_message = "4,#"+username+"#"+private_key+"#"+receiver+"#"+mosaic_name+"#"+mosaic_payload
...
st4 = wx.StaticText(win, label = "Contract Name: ")
st4.SetFont(font)
...
st5 = wx.StaticText(win, label = "Contract Content: ")
st5.SetFont(font)
hbox5.Add(st5)
...
input_text6.SetHint("Ref No: Referal Number, Date: dd/mm/yyyy, Time : HH:MM, \nPayment Medium: ---- , Payment Duration : ---- \nItems Bought: ---")
